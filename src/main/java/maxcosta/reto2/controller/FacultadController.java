...
public class FacultadController {
    ...
    public ResponseEntity<Facultad> obtenerFacultadPorId(@PathVariable("id") Long idEscuela) {
        Facultad facultadEncontrada = this.facultadService.buscarFacultadPorId(idEscuela);
        return new ResponseEntity<>(facultadEncontrada, OK);
    }
